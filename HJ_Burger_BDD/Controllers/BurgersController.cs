...
namespace HJ_Burger_BDD.Controllers
{
    public class BurgersController : Controller
    {
        private readonly HJ_Burger_BDDContext _context;

        public BurgersController(HJ_Burger_BDDContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Burger != null ? 
                          ...
                          Problem("Entity set 'HJ_Burger_BDDContext.Burger'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'HJ_Burger_BDDContext.Burger'  is null.");
            }
            var burger = await _context.Burger.FindAsync(id);
            if (burger != null)
            {
